/*
 * For a detailed explanation regarding each configuration
 * property and type check, visit:
...
export default {
  ...
  // cacheDirectory:
  // "/private/var/folders/wr/qglzf62d7lx8fyp9375jtlqh0000gn/T/jest_dx",
  ...
  // or to arrays of module names that allow to stub out resources with
  // a single module
  // moduleNameMapper: {},
